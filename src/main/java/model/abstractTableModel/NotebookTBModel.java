...
public class NotebookTBModel extends AbstractTableModel {
    ...
    public NotebookTBModel(List<Maquina> data) {
        this.data = data;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 11: return x.getEquipamento().getDisponivelEmprestimo();
            case 12: return x.getEquipamento().getObservacao();
            case 13: return x.getEquipamento().getStatus();
