...
public class DispatcherDesktop implements DispatcherInterface {
    ...
    private final String sqlRead = "select " +
            ...
            "inner join tbequipamento e on m.fk_equipamentoID = e.equipamentoID and e.tipoEquipamento = 'Desktop' " +
    ...
    private final String sqlDelete = "DELETE desktop " +
            ...
            "ON desktop.fk_equipamentoID = equipamento.equipamentoID AND equipamento.tipoEquipamento = 'Desktop' " +
    ...
    private final String sqlUpdate = "UPDATE tbmaquina " +
            ...
            "INNER JOIN tbequipamento equipamento ON maquina.fk_equipamentoID = equipamento.equipamentoID AND equipamento.tipoEquipamento = 'Desktop' " +
